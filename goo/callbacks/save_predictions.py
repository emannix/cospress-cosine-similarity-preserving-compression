...
from torchmetrics import JaccardIndex, CalibrationError
...
class SavePredictions(Callback):
    ...
    def setup(self, trainer, pl_module, stage):
        ...
        if 'ECE' in self.metrics_calculate:
            self.metrics_calculate_fnc['ECE'] = CalibrationError(task="multiclass", num_classes=self.num_classes, norm='l1') # expected calibration error
        # ====================
